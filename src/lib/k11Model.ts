...
export function predict(features: TrackFeatures, genero: string): Prediction {
  ...
  // Calcular score e HDI. Score e re-clamped em [0, 100] (Wave 4 m7) por
  // defesa: cada pred por-sample ja esta clampada, mas em caso degenerado
  // (N=1 ou arithmetic overflow) o score poderia quebrar o contrato.
  let sum = 0;
